...
<div class="prose grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
  <a
    href="https://fluffy-lemonade.vercel.app"
    class="font-display leading-tight"
  >
    <span class="link link-underline link-underline-black text-white">
      fluffy-lemonade.vercel.app</span
    >
  </a>
</div>
zu finden.
